...
namespace WebApplicationTest.Controllers
{
    public class RemindersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Note,Reasoning")] Reminder reminder)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Note,Reasoning")] Reminder reminder)
        {
            if (id != reminder.Id)
            {
                return NotFound();
